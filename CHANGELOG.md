...
* Fix for explicitly-typed lambda parameters in JDK 24+ by @msridhar in https://github.com/uber/NullAway/pull/1452
* Improve handling of wildcard upper bounds in generic method inference by @dhruv-agr in https://github.com/uber/NullAway/pull/1454
* Add default support for @PostConstruct as an initializer annotation by @msridhar in https://github.com/uber/NullAway/pull/1459
* Include nested annotation information in astubx files when loading external library models by @haewiful in https://github.com/uber/NullAway/pull/1456
* JSpecify: assume NONNULL in generic method inference for unconstrained type variables by @msridhar in https://github.com/uber/NullAway/pull/1471
* JSpecify: improve inference for generic methods based on method reference arguments by @msridhar in https://github.com/uber/NullAway/pull/1438
* Improve printing of annotated type variables in error messages by @msridhar in https://github.com/uber/NullAway/pull/1478
* Initial handling of constructor diamond operators by @msridhar in https://github.com/uber/NullAway/pull/1464
* Handle restrictive type-use `@NonNull` annotations on varargs array by @msridhar in https://github.com/uber/NullAway/pull/1484
* test case for issue 1493 by @msridhar in https://github.com/uber/NullAway/pull/1496
* Fix library modeling for varargs arrays by @msridhar in https://github.com/uber/NullAway/pull/1485
* Re-introduce annotations elided by `javac` for certain cases by @msridhar in https://github.com/uber/NullAway/pull/1473
* JDK javac plugin: properly handle nested annotations on array parameter types and varargs by @msridhar in https://github.com/uber/NullAway/pull/1497
* Print only `@Nullable` type use annotations in error messages by @msridhar in https://github.com/uber/NullAway/pull/1507
* Better handling of method references passed to generic methods in JSpecify mode by @msridhar in https://github.com/uber/NullAway/pull/1499
* Support for Spring's @Value annotation by @msridhar in https://github.com/uber/NullAway/pull/1505
* Fix crash with captured array types by @msridhar in https://github.com/uber/NullAway/pull/1508
* Maintenance
  * Update comments in NullabilityUtil#hasAnyAnnotationMatching by @msridhar in https://github.com/uber/NullAway/pull/1457
  * Update to Gradle 9.3.1 by @msridhar in https://github.com/uber/NullAway/pull/1458
  * Update to Error Prone 2.47.0 by @msridhar in https://github.com/uber/NullAway/pull/1461
  * Switch InvocationAndContext to be a record by @msridhar in https://github.com/uber/NullAway/pull/1463
  * Upgrade GitHub Actions for Node 24 compatibility by @salmanmkc in https://github.com/uber/NullAway/pull/1465
  * Upgrade GitHub Actions to latest versions by @salmanmkc in https://github.com/uber/NullAway/pull/1466
  * Bump various dependencies by @msridhar in https://github.com/uber/NullAway/pull/1469
  * Use text blocks in `CustomLibraryModelsTests` by @msridhar in https://github.com/uber/NullAway/pull/1482
  * Update Error Prone and EP plugin by @msridhar in https://github.com/uber/NullAway/pull/1486
  * Update to Gradle 9.4.0 by @msridhar in https://github.com/uber/NullAway/pull/1491
  * Minor cleanup, no behavior changes by @armandino in https://github.com/uber/NullAway/pull/1487
  * Update to Error Prone 2.49.0 by @msridhar in https://github.com/uber/NullAway/pull/1514
