## NullAway: Fast Annotation-Based Null Checking for Java [![Build Status](https://travis-ci.org/uber/NullAway
.svg?branch=master)](https://travis-ci.org/uber/NullAway) [![Coverage Status](https://coveralls.io/repos/github/uber/NullAway/badge.svg?branch=lazaro_coveralls)](https://coveralls.io/github/uber/NullAway?branch=lazaro_coveralls)
