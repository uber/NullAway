...
public final class GenericsChecks {
  ...
  private boolean compareNullabilityAnnotations(Type lhsType, Type rhsType) {
    // it is fair to assume rhyType should be the same as lhsType as the Java compiler has passed before NullAway.
  ...
  private final Type.Visitor<List<Type>, Void> TYPE_ARG_VISITOR =
          new Type.Visitor<List<Type>, Void>() {
            @Override
            public List<Type> visitClassType(Type.ClassType t, Void s) {return t.getTypeArguments();}
            @Override
            ...
            @Override
            public List<Type> visitMethodType(Type.MethodType t, Void unused) {return null;}
            @Override
            public List<Type> visitPackageType(Type.PackageType t, Void unused) {return null;}
            @Override
            public List<Type> visitModuleType(Type.ModuleType t, Void unused) {return null;}
            @Override
            public List<Type> visitTypeVar(Type.TypeVar t, Void unused) {return null;}
            @Override
            public List<Type> visitCapturedType(Type.CapturedType t, Void s) {
              return t.wildcard.accept(this, null);
            }
            @Override
            public List<Type> visitForAll(Type.ForAll t, Void unused) {return null;}
            @Override
            public List<Type> visitUndetVar(Type.UndetVar t, Void unused) {return null;}
            @Override
            public List<Type> visitErrorType(Type.ErrorType t, Void unused) {return null;}
            @Override
            public List<Type> visitWildcardType(Type.WildcardType t, Void unused) {return null;}
            @Override
