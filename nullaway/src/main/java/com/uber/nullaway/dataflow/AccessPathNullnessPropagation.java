...
public class AccessPathNullnessPropagation
  ...
  public TransferResult<Nullness, NullnessStore> visitArrayAccess(
    ...
    Nullness resultNullness = Nullness.NONNULL;
    ...
    if (config.isJSpecifyMode()) {
      ...
      if (arraySymbol != null) {
        ...
        resultNullness = isElementNullable ? Nullness.NULLABLE : Nullness.NONNULL;
      }
    }

    // Update the store based on the result nullness determined above
