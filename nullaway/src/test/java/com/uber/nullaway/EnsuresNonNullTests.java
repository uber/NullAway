  ...
  public void requiresEnsuresNonNullStaticFields() {
    defaultCompilationHelper
        .addSourceLines(
            ...
            "  }",
            "  @RequiresNonNull(\"this.nullableItem\")",
            "  // BUG: Diagnostic contains: Currently, @RequiresNonNull does not support this. annotations for static fields.",
            "  public static void test() {",
            "  // BUG: Diagnostic contains:  dereferenced expression nullableItem is @Nullable",
            "    nullableItem.call();",
            "  }",
            "  @EnsuresNonNull(\"this.nullableItem\")",
            "  // BUG: Diagnostic contains: Currently, @EnsuresNonNull does not support this. annotations for static fields.",
