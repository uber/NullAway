  ...
  public void testForLambdasInAnAssignment() {
    makeHelper()
        .addSourceLines(
            ...
            "  }",
            "  static void testPositive() {",
            "    // we should report an error here, since the lambda cannot take",
            "    // a @Nullable parameter.  we don't catch this yet",
  ...
  public void testForDiamondInAnAssignment() {
    makeHelper()
        .addSourceLines(
            ...
            "  }",
            "  static void testPositive() {",
            "    // we should report an error here, since the overriding method cannot take",
            "    // a @Nullable parameter.  we don't catch this yet",
            "    A<@Nullable Object> p = new A<>() {",
            "      @Override",
            "      public String function(Object o) { return o.toString(); }",
            "    };",
            "  }",
            "  static void testNegative() {",
            "    A<Object> p = new A<>() {",
