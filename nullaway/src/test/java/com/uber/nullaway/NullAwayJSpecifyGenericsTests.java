  ...
  public void testForMethodReferenceInAnAssignment() {
    makeHelper()
        .addSourceLines(
            ...
            "    String function(T1 o, T2 p);",
            "  }",
            "  static String foo(@Nullable Object o, String string) {",
            "    return o != null ? o.toString() : string;",
            "  }",
            "  static void testPositive() {",
            "    // we should report an error here, since Test::foo conforms to",
            "    // A<@Nullable Object, String>.  But we do not handle this case yet",
            "    A<Object, String> p = Test::foo;",
            "  }",
            "  static void testNegative() {",
