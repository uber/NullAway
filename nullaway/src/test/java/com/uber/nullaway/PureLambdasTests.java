 ...
 * (methods annotated with @Contract(pure = true)). Variables captured in such lambdas
 * should not be treated as automatically nullable; instead, the facts at the call site
 * should be visible in the lambda body.
 */
