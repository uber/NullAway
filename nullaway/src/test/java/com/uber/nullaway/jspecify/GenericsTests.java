        ...
        .addSourceLines(
            ...
            public abstract class Generics<V> {
                ...
                void testPositive1(Function<@Nullable V, V> f) {
                    // BUG: Diagnostic contains: incompatible types: Function<@Nullable V, V> cannot be converted to Function<V, @Nullable V>
                    foo(f);
                }
                ...
                void testPositive3(Function<@Nullable V, @Nullable V> f) {
                    // BUG: Diagnostic contains: incompatible types: Function<@Nullable V, @Nullable V> cannot be converted to Function<V, @Nullable V>
                    foo(f);
                }
            }
            """)
